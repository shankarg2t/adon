    ...
    if(productId) {
        ...
        new Ajax.Updater('SCPcustomOptionsDiv', coUrl, {
            ...
            onComplete: function() {
                ...
                // apply easytabs magic
                jQuery('#easyCustomOptionsTabs').easytabs({
                    animate: false,
                    defaultTab: "#tab0"
                });
                /* custom option show pantone value text field if Pantone color option super-attribute is selected */
                if (jQuery("#attribute92 option:selected").text().indexOf("Pantone") >= 0) {
                    jQuery('.product-options .swatchesContainer').css('margin-bottom','85px');
