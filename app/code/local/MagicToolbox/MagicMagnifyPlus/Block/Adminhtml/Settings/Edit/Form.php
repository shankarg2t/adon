...
class MagicToolbox_MagicMagnifyPlus_Block_Adminhtml_Settings_Edit_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm()  {
        ...
        $form = new Varien_Data_Form(array(
            ...
            'class' => 'magicmagnifyplusEditForm'
        ));
...
<script type="text/javascript">
    ...
    var fieldsets = getElementsByClass("magicmagnifyplusFieldset");
    var header = null;
    var buttons = null;
    var magicmagnifyplusFieldsetId = "";
    for(var i = 0, l = fieldsets.length; i < l; i++) {
        ...
        if(magicmagnifyplusFieldsetId != id) {
            magicmagnifyplusFieldsetId = id;
        } else {
            header.click();
        }
    }
    initOptionsValidation("magicmagnifyplus[product][template]", "magicmagnifyplus[product][magicscroll]");
    var magicscrollIcon = document.createElement("img");
    magicscrollIcon.id = "magicscroll_icon";
    magicscrollIcon.src = "'.$this->getSkinUrl("magicmagnifyplus/magicscroll.png").'";
