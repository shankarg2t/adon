...
//            exit;                        
    ...
    public function getIsRequire() {
        ...
        if (       ($moduleName=='checkout' && $actionName!='configure') 
                ...
                || (($controllerName=='sales_order_edit' || $controllerName=='sales_order_create' || $controllerName=='orderspro_order_edit') && ($actionName=='loadBlock' || $actionName=='index' || $actionName=='save'))
                || $actionName=='reorder'
           ) {            
