...
class Mage_Page_Block_Html_Topmenu extends Mage_Core_Block_Template {
    ...
    protected function _getHtml(Varien_Data_Tree_Node $menuTree, $childrenWrapClass) {
        ...
        foreach ($children as $child) {
            ...
            //$childrenHtml = $this->_getHtml($child, $childrenWrapClass);
            //if (strstr($childrenHtml, 'active')) {
            //    $html .= '<li ' . $this->_getRenderedMenuItemAttributesForSub($child) . '>';
            //} else {
     ...
     * @return string
     */
    protected function _getRenderedMenuItemAttributesForSub(Varien_Data_Tree_Node $item) {
        $html = '';
        $attributes = $this->_getMenuItemAttributes($item);

        foreach ($attributes as $attributeName => $attributeValue) {
            $html .= ' ' . $attributeName . '="' . str_replace('"', '\"', $attributeValue) . ' subACT"';
        }
