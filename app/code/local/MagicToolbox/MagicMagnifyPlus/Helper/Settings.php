...
class MagicToolbox_MagicMagnifyPlus_Helper_Settings extends Mage_Core_Helper_Abstract {
    ...
    public function __construct() {
        ...
        $this->_magicToolboxListTemplateFilename = $designPackage->getTemplateFilename('magicmagnifyplus'.DS.'magictoolbox_list.phtml');
    ...
    public function loadTool($profile = '') {
        ...
        if(null === self::$_toolCoreClass) {
            ...
            self::$_toolCoreClass = new MagicMagnifyPlusModuleCoreClass();
            ...
            $coll = Mage::getModel('magicmagnifyplus/settings')->getCollection();
            ...
            foreach($helper->getBlocks() as $id => $label) {
                ...
                /* load locale */
                $locale = $this->__('MagicMagnifyPlus_Message');
                if($locale != 'MagicMagnifyPlus_Message') {
            ...
            if(self::$_toolCoreClass->type == 'standard') {
                if(self::$_toolCoreClass->params->checkValue('magicscroll', 'yes', 'product')) {
                    require_once(BP . str_replace('/', DS, '/app/code/local/MagicToolbox/MagicMagnifyPlus/core/magicscroll.module.core.class.php'));
                ...
                require_once(BP . str_replace('/', DS, '/app/code/local/MagicToolbox/MagicMagnifyPlus/core/magictoolbox.templatehelper.class.php'));
                MagicToolboxTemplateHelperClass::setPath(dirname(Mage::getSingleton('core/design_package')->getTemplateFilename('magicmagnifyplus'.DS.'media.phtml')) . DS . 'templates');
    ...
    public function isModuleOutputEnabled($moduleName = null) {
        ...
        if($moduleName === null) {
            $moduleName = 'MagicToolbox_MagicMagnifyPlus';//$this->_getModuleName();
        }
