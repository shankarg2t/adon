...
jQuery(document).ready(function($) {
  $('<div></div>').html(IE6UPDATE_OPTIONS.message || 'Ihr Browser ben&ouml;ntigt ein Update um diese Webseite korrekt anzeigen zu k&ouml;nnen. Klicken Sie hier f&uuml;r ein Update... ')
