...
class MagicToolbox_MagicMagnifyPlus_Block_Html_Head extends Mage_Page_Block_Html_Head {
            ...
            if(preg_match($pattern, $mageVersion, $matches)) {
                if(version_compare($matches[1], '1.4.1', '<')) {
                    if(isset($this->_data['items']['js/varien/menu.js'])) {
                        $this->_data['items']['js/varien/menu.js']['name'] = 'magicmagnifyplus/menu.js';
                    }
                    if(isset($this->_data['items']['js/varien/iehover-fix.js'])) {
                        $this->_data['items']['js/varien/iehover-fix.js']['name'] = 'magicmagnifyplus/iehover-fix.js';
                    }
                }
            }
        }
